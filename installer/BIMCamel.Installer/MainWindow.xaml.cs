...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        DetectedText.Text = detected.Length > 0
            ...
            : "No supported Navisworks (2024–2027) detected. You can still install; the ribbon appears once one is present.";
    ...
    private void Remove_Click(object sender, RoutedEventArgs e)
    {
        var confirm = MessageBox.Show(
            this,
            "Remove the BIMCamel IFC Exporter from this machine?\n\nYour exported IFC files and saved export profiles are not touched.",
            "BIMCamel IFC Exporter Setup",
        ...
        Task.Run(() =>
        {
            try
            {
                ...
                Dispatcher.Invoke(() =>
                {
                    ...
                    DoneBody.Text = "The BIMCamel IFC Exporter has been uninstalled. Your exported IFC files and saved export profiles were left untouched.";
                    ShowPanel(DonePanel);
                });
            }
            catch (Exception ex)
    ...
    private void ShowInstallDone()
    {
        ...
        var which = detected.Length > 0
            ...
            : "Navisworks Manage or Simulate 2024/2025/2026/2027";
        var verb = InstallerEngine.IsNavisworksRunning() ? "Restart" : "Start";
        DoneBody.Text = verb + " " + which +
            " — the BIMCamel ribbon tab appears with the IFC exporter button.";
        ShowPanel(DonePanel);
    }
    ...
    private void Website_Click(object sender, RoutedEventArgs e) =>
        Process.Start(new ProcessStartInfo("https://www.bimcamel.com/Export-Navisworks-to-Ifc")
        {

...
namespace BIMCamel
{
    ...
    /// 2024-2027. Runs on Application.Idle, so it executes on the UI thread after the ribbon exists,
    ...
    internal static class RibbonTabMerger
    {
        ...
        private static void Merge()
        {
            ...
            {
                if (tab == null || !TabId.Equals(GetProp<string>(tab, "Id"), StringComparison.Ordinal)) continue;
